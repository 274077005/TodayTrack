...
#import "SkyerImagePicker.h"

@interface SkyerImagePicker()<UIActionSheetDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
static SkyerImagePicker *bdImagePickerInstance = nil;

@implementation SkyerImagePicker
...
+ (void)showImagePickerFromViewController:(UIViewController *)viewController allowsEditing:(BOOL)allowsEditing finishAction:(BDImagePickerFinishAction)finishAction {
    if (bdImagePickerInstance == nil) {
        bdImagePickerInstance = [[SkyerImagePicker alloc] init];
    }
